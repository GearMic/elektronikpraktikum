...
Erhöhung von $\mu_r$ bzw. $L'$ erhöht den Wellenwiderstand, erhöhung von $\epsilon_r$ bzw. $C'$ verringert ihn.
...
für den Wellenwiderstand $Z=\frac{L'}{C'} = \sqrt{\frac{\mu_r \mu_0}{\epsilon_r \epsilon_0}} \frac{\ln(R_\mr a / R_\mr i)}{2\pi} = 120\pi \unit{\ohm} \frac{\ln{2.3}}{2\pi} \approx 49.97\unit{\ohm}$.
